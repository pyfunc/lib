...
### Removed
- Changes in requirements/docs.txt
- Changes in requirements/runtime.txt
- Changes in requirements/test.txt
- Changes in temp_wheel/pyfunc2-0.1.21.dist-info/METADATA
- Changes in temp_wheel/pyfunc2-0.1.21.dist-info/RECORD
- Changes in temp_wheel/pyfunc2-0.1.21.dist-info/WHEEL
- Changes in temp_wheel/pyfunc2-0.1.21.dist-info/licenses/LICENSE
- Changes in temp_wheel/pyfunc2-0.1.21.dist-info/top_level.txt
- Changes in temp_wheel/pyfunc2/__init__.py
- Changes in temp_wheel/pyfunc2/_version.py
- Changes in temp_wheel/pyfunc2/config/__init__.py
- Changes in temp_wheel/pyfunc2/config/ftp_download.py
- Changes in temp_wheel/pyfunc2/config/ftp_update.py
- Changes in temp_wheel/pyfunc2/config/get_config.py
- Changes in temp_wheel/pyfunc2/config/get_email_path.py
- Changes in temp_wheel/pyfunc2/config/get_ftp_path.py
- Changes in temp_wheel/pyfunc2/email/__init__.py
- Changes in temp_wheel/pyfunc2/email/all_lasts.py
- Changes in temp_wheel/pyfunc2/email/connect.py
- Changes in temp_wheel/pyfunc2/email/delete_emails.py
- Changes in temp_wheel/pyfunc2/email/download_all_attachments_in_inbox.py
- Changes in temp_wheel/pyfunc2/email/download_attachments.py
- Changes in temp_wheel/pyfunc2/email/download_attachments_in_email.py
- Changes in temp_wheel/pyfunc2/email/download_emails.py
- Changes in temp_wheel/pyfunc2/email/email_update.py
- Changes in temp_wheel/pyfunc2/email/get_path_file.py
- Changes in temp_wheel/pyfunc2/email/lasts.py
- Changes in temp_wheel/pyfunc2/file/__init__.py
- Changes in temp_wheel/pyfunc2/file/append.py
- Changes in temp_wheel/pyfunc2/file/archive_path_list.py
- Changes in temp_wheel/pyfunc2/file/check_and_create_path.py
- Changes in temp_wheel/pyfunc2/file/check_and_create_path_from_filepath.py
- Changes in temp_wheel/pyfunc2/file/check_existing_folder_list_in_path.py
- Changes in temp_wheel/pyfunc2/file/convert_pdf_to_base64.py
- Changes in temp_wheel/pyfunc2/file/create.py
- Changes in temp_wheel/pyfunc2/file/dir_list.py
- Changes in temp_wheel/pyfunc2/file/file_list.py
- Changes in temp_wheel/pyfunc2/file/find_duplicates.py
- Changes in temp_wheel/pyfunc2/file/get_filename_from_path.py
- Changes in temp_wheel/pyfunc2/file/get_hash.py
- Changes in temp_wheel/pyfunc2/file/get_hash_sha256.py
- Changes in temp_wheel/pyfunc2/file/is_file_hidden.py
- Changes in temp_wheel/pyfunc2/file/is_path_hidden.py
- Changes in temp_wheel/pyfunc2/file/move_duplicate_files.py
- Changes in temp_wheel/pyfunc2/file/move_file.py
- Changes in temp_wheel/pyfunc2/file/pdf_merge.py
- Changes in temp_wheel/pyfunc2/file/read_as_array.py
- Changes in temp_wheel/pyfunc2/file/read_as_text.py
- Changes in temp_wheel/pyfunc2/file/remove_duplicates.py
- Changes in temp_wheel/pyfunc2/file/remove_duplicates_in_path.py
- Changes in temp_wheel/pyfunc2/file/remove_empty_folders.py
- Changes in temp_wheel/pyfunc2/file/sum_year_from_path_to_file.py
- Changes in temp_wheel/pyfunc2/file/update.py
- Changes in temp_wheel/pyfunc2/img_to_base64.py
- Changes in temp_wheel/pyfunc2/to_lower_case.py
- Changes in wheel_fix/pyfunc2-0.1.23.dist-info/METADATA
- Changes in wheel_fix/pyfunc2-0.1.23.dist-info/RECORD
- Changes in wheel_fix/pyfunc2-0.1.23.dist-info/WHEEL
- Changes in wheel_fix/pyfunc2-0.1.23.dist-info/licenses/LICENSE
- Changes in wheel_fix/pyfunc2-0.1.23.dist-info/top_level.txt
- Changes in wheel_fix/pyfunc2/__init__.py
- Changes in wheel_fix/pyfunc2/_version.py
- Changes in wheel_fix/pyfunc2/config/__init__.py
- Changes in wheel_fix/pyfunc2/config/ftp_download.py
- Changes in wheel_fix/pyfunc2/config/ftp_update.py
- Changes in wheel_fix/pyfunc2/config/get_config.py
- Changes in wheel_fix/pyfunc2/config/get_email_path.py
- Changes in wheel_fix/pyfunc2/config/get_ftp_path.py
- Changes in wheel_fix/pyfunc2/email/__init__.py
- Changes in wheel_fix/pyfunc2/email/all_lasts.py
- Changes in wheel_fix/pyfunc2/email/connect.py
- Changes in wheel_fix/pyfunc2/email/delete_emails.py
- Changes in wheel_fix/pyfunc2/email/download_all_attachments_in_inbox.py
- Changes in wheel_fix/pyfunc2/email/download_attachments.py
- Changes in wheel_fix/pyfunc2/email/download_attachments_in_email.py
- Changes in wheel_fix/pyfunc2/email/download_emails.py
- Changes in wheel_fix/pyfunc2/email/email_update.py
- Changes in wheel_fix/pyfunc2/email/get_path_file.py
- Changes in wheel_fix/pyfunc2/email/lasts.py
- Changes in wheel_fix/pyfunc2/file/__init__.py
- Changes in wheel_fix/pyfunc2/file/append.py
- Changes in wheel_fix/pyfunc2/file/archive_path_list.py
- Changes in wheel_fix/pyfunc2/file/check_and_create_path.py
- Changes in wheel_fix/pyfunc2/file/check_and_create_path_from_filepath.py
- Changes in wheel_fix/pyfunc2/file/check_existing_folder_list_in_path.py
- Changes in wheel_fix/pyfunc2/file/convert_pdf_to_base64.py
- Changes in wheel_fix/pyfunc2/file/create.py
- Changes in wheel_fix/pyfunc2/file/dir_list.py
- Changes in wheel_fix/pyfunc2/file/file_list.py
- Changes in wheel_fix/pyfunc2/file/find_duplicates.py
- Changes in wheel_fix/pyfunc2/file/get_filename_from_path.py
- Changes in wheel_fix/pyfunc2/file/get_hash.py
- Changes in wheel_fix/pyfunc2/file/get_hash_sha256.py
- Changes in wheel_fix/pyfunc2/file/is_file_hidden.py
- Changes in wheel_fix/pyfunc2/file/is_path_hidden.py
- Changes in wheel_fix/pyfunc2/file/move_duplicate_files.py
- Changes in wheel_fix/pyfunc2/file/move_file.py
- Changes in wheel_fix/pyfunc2/file/pdf_merge.py
- Changes in wheel_fix/pyfunc2/file/read_as_array.py
- Changes in wheel_fix/pyfunc2/file/read_as_text.py
- Changes in wheel_fix/pyfunc2/file/remove_duplicates.py
- Changes in wheel_fix/pyfunc2/file/remove_duplicates_in_path.py
- Changes in wheel_fix/pyfunc2/file/remove_empty_folders.py
- Changes in wheel_fix/pyfunc2/file/sum_year_from_path_to_file.py
- Changes in wheel_fix/pyfunc2/file/update.py
- Changes in wheel_fix/pyfunc2/img_to_base64.py
- Changes in wheel_fix/pyfunc2/to_lower_case.py

## [0.1.28] - 2025-04-15

### Added
- Changes in src/pyfunc2/all_lasts.py
...
- Changes in src/pyfunc2/email_update.py
...
- Changes in src/pyfunc2/lasts.py
...
- Changes in test/test_arrayElementsAreIncluded.py
- Changes in test/test_differenceElementsInArrays.py
